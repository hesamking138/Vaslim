...
public partial class GamePing : ContentPage
{
    ...
    private async void OnGameSelected(object sender, SelectionChangedEventArgs e)
    {
        ...
        {
            MenuDimmer.IsVisible = false; // Close the island!
    ...
    // THE ISLAND CONTROLS
    private void OnHamburgerClicked(object sender, EventArgs e) => MenuDimmer.IsVisible = true;
    private void OnCloseSidebarClicked(object sender, EventArgs e)
    {
       MenuDimmer.IsVisible = false;
